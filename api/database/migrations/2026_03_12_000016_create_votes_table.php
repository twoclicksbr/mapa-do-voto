...
return new class extends Migration
{
    ...
    {
        // Particionada por RANGE(year) com subpartição por LIST(state_id)
        // PRIMARY KEY inclui (id, year, state_id) — exigência do PostgreSQL para tabelas sub-particionadas
        DB::unprepared('
            CREATE TABLE votes (
        ...
        // Partições por ano (sub-particionadas por state_id)
        DB::unprepared('
        ...
        // Subpartições default para cada ano (acomodam todos os state_ids durante importação)
        DB::unprepared('
        ...
        // Índices para queries de totalização
