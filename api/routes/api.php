...
use App\Http\Controllers\AttendanceAddressController;
use App\Http\Controllers\AttendanceContactController;
use App\Http\Controllers\AttendanceController;
use App\Http\Controllers\AttendanceDocumentController;
...
Route::middleware(['tenant', 'auth:sanctum'])->group(function () {
    ...
    Route::put('/attendances/reorder', [AttendanceController::class, 'reorder']);
    Route::get('/attendances/{id}', [AttendanceController::class, 'show']);
    Route::post('/attendances', [AttendanceController::class, 'store']);
    Route::put('/attendances/{id}', [AttendanceController::class, 'update']);
    Route::delete('/attendances/{id}', [AttendanceController::class, 'destroy']);
    Route::get('/attendances/{id}/people', [AttendanceController::class, 'peopleIndex']);
    Route::post('/attendances/{id}/people', [AttendanceController::class, 'peopleStore']);
    Route::delete('/attendances/{id}/people/{pid}', [AttendanceController::class, 'peopleDestroy']);
    Route::get('/attendances/{id}/history', [AttendanceController::class, 'historyIndex']);
    Route::post('/attendances/{id}/history', [AttendanceController::class, 'historyStore']);
    Route::get('/attendances/{id}/contacts', [AttendanceContactController::class, 'index']);
    Route::post('/attendances/{id}/contacts', [AttendanceContactController::class, 'store']);
    Route::put('/attendances/{id}/contacts/{cid}', [AttendanceContactController::class, 'update']);
    Route::delete('/attendances/{id}/contacts/{cid}', [AttendanceContactController::class, 'destroy']);
    Route::get('/attendances/{id}/documents', [AttendanceDocumentController::class, 'index']);
    Route::post('/attendances/{id}/documents', [AttendanceDocumentController::class, 'store']);
    Route::put('/attendances/{id}/documents/{did}', [AttendanceDocumentController::class, 'update']);
    Route::delete('/attendances/{id}/documents/{did}', [AttendanceDocumentController::class, 'destroy']);
    Route::get('/attendances/{id}/addresses', [AttendanceAddressController::class, 'index']);
    Route::post('/attendances/{id}/addresses', [AttendanceAddressController::class, 'store']);
    Route::put('/attendances/{id}/addresses/{aid}', [AttendanceAddressController::class, 'update']);
    Route::delete('/attendances/{id}/addresses/{aid}', [AttendanceAddressController::class, 'destroy']);
    Route::get('/attendances/{id}/notes', [AttendanceNoteController::class, 'index']);
    Route::post('/attendances/{id}/notes', [AttendanceNoteController::class, 'store']);
    Route::delete('/attendances/{id}/notes/{nid}', [AttendanceNoteController::class, 'destroy']);
