...
export interface TypePeopleFilters {
  filterId?:   string;
  filterName?: string;
  status?:     string[];
  dateField?:  string;
...
interface TypePeopleFilterModalProps {
  open: boolean;
  filters: TypePeopleFilters;
  onClose: () => void;
  onApply: (filters: TypePeopleFilters) => void;
}

export function TypePeopleFilterModal({ open, filters, onClose, onApply }: TypePeopleFilterModalProps) {
      ...
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Pesquisa Avançada — Tipos de Pessoa
          </DialogTitle>
        </DialogHeader>
