...
interface TypePeopleDataGridProps {
  ...
  onEdit?: (tp: TypePeople) => void;
  onDelete?: (id: number) => void;
  onReorder?: (id: number, newOrder: number) => void;
}

export function TypePeopleDataGrid({
  typePeople,
  isLoading,
  onSelectionChange,
  onEdit,
  ...
  const columns = useMemo<ColumnDef<TypePeople>[]>(
    () => [
      {
        id: "drag",
        header: () => null,
  ...
  const table = useReactTable({
    ...
    getRowId: (row: TypePeople) => String(row.id),
