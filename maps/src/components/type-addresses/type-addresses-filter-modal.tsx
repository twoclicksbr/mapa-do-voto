...
export interface TypeAddressesFilters {
  filterId?:   string;
  filterName?: string;
  status?:     string[];
  dateField?:  string;
...
interface TypeAddressesFilterModalProps {
  open: boolean;
  filters: TypeAddressesFilters;
  onClose: () => void;
  onApply: (filters: TypeAddressesFilters) => void;
}

export function TypeAddressesFilterModal({ open, filters, onClose, onApply }: TypeAddressesFilterModalProps) {
      ...
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Pesquisa Avançada — Tipos de Endereço
          </DialogTitle>
        </DialogHeader>
