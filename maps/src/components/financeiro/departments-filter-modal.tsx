...
interface DepartmentsFilterModalProps {
  open:    boolean;
...
export function DepartmentsFilterModal({
  open, filters, onClose, onApply,
}: DepartmentsFilterModalProps) {
      ...
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Pesquisa Avançada — Departamentos
          </DialogTitle>
        </DialogHeader>
        <DialogBody className="space-y-4">
          ...
          {/* Linha 2: Pesquisar por(3) + Período(9) */}
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-2 space-y-1.5">
