...
export interface FinPaymentMethodTypesFilters {
  filterId?:   string;
  filterName?: string;
  status?:     string[];
  dateField?:  string;
...
interface FinPaymentMethodTypesFilterModalProps {
  open: boolean;
  filters: FinPaymentMethodTypesFilters;
  onClose: () => void;
  onApply: (filters: FinPaymentMethodTypesFilters) => void;
}

export function FinPaymentMethodTypesFilterModal({ open, filters, onClose, onApply }: FinPaymentMethodTypesFilterModalProps) {
  ...
  const hasFilters = !!(filterId || filterName || statuses.length || dateValue);
      ...
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Pesquisa Avançada — Tipos de Modalidade
          </DialogTitle>
        </DialogHeader>
