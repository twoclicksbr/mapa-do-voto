...
export interface FinPaymentMethodType {
  id: number;
  name: string;
  order: number;
  active: boolean;
...
interface FinPaymentMethodTypesDataGridProps {
  types: FinPaymentMethodType[];
  isLoading: boolean;
  onSelectionChange?: (count: number) => void;
  onEdit?: (type: FinPaymentMethodType) => void;
  onDelete?: (id: number) => void;
  onReorder?: (reordered: FinPaymentMethodType[]) => void;
}

export function FinPaymentMethodTypesDataGrid({
  types,
  isLoading,
  onSelectionChange,
  onEdit,
  onDelete,
  onReorder,
}: FinPaymentMethodTypesDataGridProps) {
  ...
  const columns = useMemo<ColumnDef<FinPaymentMethodType>[]>(
    () => [
      {
        id: "drag",
        header: () => null,
  ...
  const table = useReactTable({
    ...
    getRowId: (row: FinPaymentMethodType) => String(row.id),
