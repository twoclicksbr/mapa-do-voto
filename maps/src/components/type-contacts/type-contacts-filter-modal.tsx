...
export interface TypeContactsFilters {
  filterId?:   string;
  filterName?: string;
  status?:     string[];
  dateField?:  string;
...
interface TypeContactsFilterModalProps {
  open: boolean;
  filters: TypeContactsFilters;
  onClose: () => void;
  onApply: (filters: TypeContactsFilters) => void;
}

export function TypeContactsFilterModal({ open, filters, onClose, onApply }: TypeContactsFilterModalProps) {
      ...
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Pesquisa Avançada — Tipos de Contato
          </DialogTitle>
        </DialogHeader>
